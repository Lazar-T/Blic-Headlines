...
class Form(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        button3.setToolTip("<i>" + hoveringText3 + "</i>")
        button4 = QPushButton(text4, self)
        button4.setToolTip("<i>" + hoveringText4 + "</i>")
        button5 = QPushButton(text5, self)
        button5.setToolTip("<i>" + hoveringText5 + "</i>")

        button6 = QPushButton(text10, self)
        button6.setToolTip("<i>" + hoveringText6 + "</i>")
        button7 = QPushButton(text11, self)
        button7.setToolTip("<i>" + hoveringText7 + "</i>")
        button8 = QPushButton(text12, self)
        button8.setToolTip("<i>" + hoveringText8 + "</i>")
        button9 = QPushButton(text13, self)
        button9.setToolTip("<i>" + hoveringText9 + "</i>")

        button10 = QPushButton(text14, self)
        button10.setToolTip("<i>" + hoveringText10 + "</i>")
        button11 = QPushButton(text15, self)
        button11.setToolTip("<i>" + hoveringText11 + "</i>")
        button12 = QPushButton(text16, self)
        button12.setToolTip("<i>" + hoveringText12 + "</i>")
        button13 = QPushButton(text17, self)
        button13.setToolTip("<i>" + hoveringText13 + "</i>")

        button14 = QPushButton(text18, self)
        button14.setToolTip("<i>" + hoveringText14 + "</i>")
        button15 = QPushButton(text19, self)
        button15.setToolTip("<i>" + hoveringText15 + "</i>")
        button16 = QPushButton(text20, self)
        button16.setToolTip("<i>" + hoveringText16 + "</i>")
        button17 = QPushButton(text21, self)
        button17.setToolTip("<i>" + hoveringText17 + "</i>")

        button18 = QPushButton(text22, self)
        button18.setToolTip("<i>" + hoveringText18 + "</i>")
        button19 = QPushButton(text23, self)
        button19.setToolTip("<i>" + hoveringText19 + "</i>")
        button20 = QPushButton(text24, self)
        button20.setToolTip("<i>" + hoveringText20 + "</i>")
        button21 = QPushButton(text25, self)
        button21.setToolTip("<i>" + hoveringText21 + "</i>")
